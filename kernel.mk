...
build: src
	...
	echo CONFIG_BRCMUTIL=m >> $(KERNEL_DIR)/linux-tn-imx/arch/arm/configs/$(KERNEL_DEFCONFIG)
	echo CONFIG_BRCMFMAC=m >> $(KERNEL_DIR)/linux-tn-imx/arch/arm/configs/$(KERNEL_DEFCONFIG)
	echo CONFIG_BRCMFMAC_PROTO_BCDC=y >> $(KERNEL_DIR)/linux-tn-imx/arch/arm/configs/$(KERNEL_DEFCONFIG)
	echo CONFIG_BRCMFMAC_SDIO=y >> $(KERNEL_DIR)/linux-tn-imx/arch/arm/configs/$(KERNEL_DEFCONFIG)
